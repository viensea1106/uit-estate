                      ...
                      <div className="flex flex-wrap items-center">
                          <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                              <div className="p-6 bg-white dark:bg-gray-900">
                                  ...
                                  <p className="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">5,337+
                                  </p>
                                  <h2 className="text-sm text-gray-700 dark:text-gray-400">Premium Product</h2>
                              </div>
                          </div>
                          <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                              <div className="p-6 bg-white dark:bg-gray-900">
                                  ...
                                  <h2 className="text-sm text-gray-700 dark:text-gray-400">Happy Customers</h2>
                              </div>
                          </div>
                          <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                              <div className="p-6 bg-white dark:bg-gray-900">
                                  ...
                                  <p className="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">14+
                                  </p>
                                  <h2 className="text-sm text-gray-700 dark:text-gray-400">Branches</h2>
                              </div>
                          </div>
                          <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                              <div className="p-6 bg-white dark:bg-gray-900">
                                  ...
                                  <h2 className="text-sm text-gray-700 dark:text-gray-400">Years</h2>
                              </div>
                          </div>
                      </div>
                  </div>
